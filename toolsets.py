...
TOOLSETS = {
    ...
    "hermes-raft": {
        "description": "Raft channel toolset - external-agent channel integration via Raft CLI",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
